#!/bin/bash
# =============================================================================
# run_behat.sh - Executa testes Behat do plugin local_report_config via Docker
#
# Uso:
#   ./run_behat.sh                                  # Roda todos os testes @local_report_config
...
PLUGIN_COMPONENT="local_report_config"
PLUGIN_RELPATH="local/report_config"
PLUGIN_TAG="@local_report_config"
